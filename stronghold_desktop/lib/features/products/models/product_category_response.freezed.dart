...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductCategoryResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'ProductCategoryResponse(id: $id, name: $name, description: $description)';
}
...
class _ProductCategoryResponse implements ProductCategoryResponse {
  const _ProductCategoryResponse({required this.id, required this.name, this.description});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductCategoryResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
