...
class MembershipPackageEditDialog extends StatefulWidget {
  const MembershipPackageEditDialog({
    super.key,
  ...
  @override
  State<MembershipPackageEditDialog> createState() => _State();
}

class _State extends State<MembershipPackageEditDialog> {
  ...
  void initState() {
    super.initState();
    _name = TextEditingController(text: widget.package.packageName ?? '');
  ...
  Future<void> _save() async {
    ...
    try {
      await widget.onUpdate(UpdateMembershipPackageRequest(
      ...
      if (mounted) {
        Navigator.of(context).pop(
            ErrorHandler.getContextualMessage(e, 'edit-package'));
      }
    }
  }
          ...
          child: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Row(children: [
                    Expanded(child: Text('Izmijeni paket',
