...
class _TrainerEditDialogState extends State<TrainerEditDialog> {
  ...
  void initState() {
    super.initState();
    _firstName = TextEditingController(text: widget.trainer.firstName);
    _lastName = TextEditingController(text: widget.trainer.lastName);
    _email = TextEditingController(text: widget.trainer.email);
    _phone = TextEditingController(text: widget.trainer.phoneNumber);
  }
  ...
  Future<void> _save() async {
    ...
    try {
      await widget.onUpdate(UpdateTrainerRequest(
      ...
      if (mounted) {
        Navigator.of(context).pop(
            ErrorHandler.getContextualMessage(e, 'update-trainer'));
      }
    }
  }
          ...
          child: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Row(children: [
                    Expanded(child: Text('Izmijeni trenera',
