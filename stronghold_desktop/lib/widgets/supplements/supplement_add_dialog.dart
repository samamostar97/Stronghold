...
class SupplementAddDialog extends ConsumerStatefulWidget {
  const SupplementAddDialog({super.key});

  @override
  ConsumerState<SupplementAddDialog> createState() => _State();
}

class _State extends ConsumerState<SupplementAddDialog> {
    ...
    try {
      ...
      if (_imagePath != null) {
        await ref
            ...
            .uploadImage(id, _imagePath!);
      }
      if (mounted) Navigator.of(context).pop(true);
    } catch (e) {
      if (mounted) {
        Navigator.of(context)
            .pop(ErrorHandler.getContextualMessage(e, 'add-supplement'));
      }
    }
  }
  ...
  Widget _imageSection() => Row(children: [
        ...
        TextButton.icon(
          ...
          label: Text(_imagePath != null ? 'Promijeni sliku' : 'Odaberi sliku'),
