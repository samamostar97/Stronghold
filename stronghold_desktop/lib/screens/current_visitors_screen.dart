  ...
  Future<void> _handleCheckOut(CurrentVisitorDTO visitor) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${visitor.fullName} je uspješno odjavljen/a'),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            _DataCell(text: widget.visitor.duration, flex: _TableFlex.duration),
            Expanded(
...
class _CheckInDialogState extends State<_CheckInDialog> {
  ...
  Future<void> _checkInUser(UserTableRowDTO user) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${user.firstName} ${user.lastName} je uspješno prijavljen/a'),
          backgroundColor: Colors.green,
        ),
      );
