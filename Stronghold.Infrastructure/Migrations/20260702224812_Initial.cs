        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Supplements_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Memberships_MembershipPackages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryStreet = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StaffMemberId_Date_StartHour",
                table: "Appointments",
                columns: new[] { "StaffMemberId", "Date", "StartHour" },
                unique: true,
                filter: "[Status] <> 3");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeminarRegistrations_SeminarId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supplements_SupplierId",
                table: "Supplements",
                column: "SupplierId");
