...
{
    public class AdminNutritionistService : BaseService<Nutritionist, NutritionistDTO, CreateNutritionistDTO, UpdateNutritionistDTO, NutritionistQueryFilter, int>, IAdminNutritionistService
    {
        public AdminNutritionistService(IRepository<Nutritionist, int> repository, IMapper mapper) : base(repository, mapper)
        {
        }
        protected override async Task BeforeCreateAsync(Nutritionist entity, CreateNutritionistDTO dto)
        {
