...
{
    public class BaseService<T, TDto, TCreateDto, TUpdateDto, TQueryFilter, TKey> : IBaseService<T, TDto, TCreateDto, TUpdateDto, TQueryFilter, TKey>
       where T : class
       where TDto : class
...

    {
        ...
        public virtual async Task DeleteAsync(TKey id)
        {
            ...
            // Soft delete: set IsDeleted = true using reflection
