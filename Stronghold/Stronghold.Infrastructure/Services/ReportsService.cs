...
public class ReportsService : IReportsService
{
    ...
    public ReportsService(StrongholdDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<BusinessReportDTO> GetBusinessReportAsync()
    {
        ...
        // Monthly revenue (IMPORTANT: DbSet name must match your DbContext)
        // If your DbContext has MembershipPaymentHistories, use that.
