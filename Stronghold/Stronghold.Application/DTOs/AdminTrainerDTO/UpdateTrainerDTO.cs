...
namespace Stronghold.Application.DTOs.AdminTrainerDTO
{
    ...
    {
        [StringLength(30, MinimumLength = 2, ErrorMessage = "Ime trenera moze da sadrzi 2-30 karaktera")]
        public string? FirstName { get; set; }
        [StringLength(30, MinimumLength = 2, ErrorMessage = "Prezime trenera moze da sadrzi 2-30 karaktera")]
