...
public class OrdersController : ControllerBase
{
    ...
    // Checkout korak: server racuna iznos i vraca client secret za Stripe PaymentSheet.
    ...
    // Nakon placanja u aplikaciji - server verifikuje status kod Stripe-a i kreira narudzbu.
    [HttpPost("confirm")]
    [Authorize(Roles = Roles.GymMember)]
