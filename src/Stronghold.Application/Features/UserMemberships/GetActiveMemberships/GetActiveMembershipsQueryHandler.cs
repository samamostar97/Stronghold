...
public class GetActiveMembershipsQueryHandler : IRequestHandler<GetActiveMembershipsQuery, PagedResult<UserMembershipResponse>>
{
    private readonly IUserMembershipRepository _membershipRepository;

    public GetActiveMembershipsQueryHandler(IUserMembershipRepository membershipRepository)
    {
        _membershipRepository = membershipRepository;
    }

    public async Task<PagedResult<UserMembershipResponse>> Handle(GetActiveMembershipsQuery request, CancellationToken cancellationToken)
    {
